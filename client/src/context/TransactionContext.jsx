      ...
      const structuredTransactions =
        availableTransactions.map(
          (transaction) => ({
            ...
            timestamp: new Date(
              transaction.timestamp.toNumber() *
                1000,
            ).toLocaleString(),
        ...
        params: [
          {
            from: currentAccount,
            to: addressTo,
            gas: "0x5208", // 21000 GWEI - cents - Require convert to hexadecimal
            value: parsedAmount._hex, // 0.00001 - required convert to hexadecimal
          },
        ],
      });
